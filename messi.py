...
turtle.draw_fn("nose_curve", co=(218, 69, 56), mode=0)
...
turtle.draw_fn("eyeball_center", co=(230, 231, 229), mode=0)

turtle.draw_fn("hair_outline", co=(230, 231, 229), mode=0)
...
turtle.draw_fn("ear_shade3", co=(212, 138, 124), mode=0)
...
turtle.draw_fn("face_shade2", co=(208, 137, 122), mode=0)
